...
export class ContractGenerator {
   ...
   */
  private buildContractTerms(proposal: ProposalInput): ContractTerms {
   ...
   */
  private buildPaymentSchedule(proposal: ProposalInput): PaymentScheduleItem[] {
   ...
   */
  private buildMilestonePayments(proposal: ProposalInput): PaymentScheduleItem[] {
  ...
  renderToMarkdown(contract: ContractInfo, proposal: ProposalInput): string {
    ...
    if (!template) return this.renderGenericContract(contract, proposal);
  ...
  private buildVariableMap(contract: ContractInfo, proposal: ProposalInput): Record<string, string> {
  ...
  private renderGenericContract(contract: ContractInfo, proposal: ProposalInput): string {
    return [
