/**
 * Upwork OAuth2 — Contracts
 *
 * GET /api/upwork-contracts?uid=...
 */
...
module.exports = withErrorHandler(async function handler(req, res) {
  ...
  try {
    ...
    const data = await upwork.getContracts(tokens.access_token);
    ...
    console.error('[upwork-contracts] Error:', err.message);
